...
// import { SHIFT_CONFIG } from "@/core/entities/types.type";
          ...
          <CardContent className="space-y-3 pb-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                className="min-h-15 text-sm bg-secondary border-border text-foreground placeholder:text-muted-foreground"
              />
            </div>
            <Button
              onClick={handleReportAbsence}
              disabled={
                loading || !selectedEmployee || selectedEmployee === "none"
              }
              size="sm"
                  ...
                  {lastResult.replacements.map((rep, i) => (
                    ...
                    >
                      ...
                      <span className="font-medium text-foreground">
                        {/* {employeeMap.get(rep.replacementId)?.name || */}
                        {/*   "Reemplazo"} */}
                      </span>
                      <Badge
                        variant="outline"
                ...
                <TableRow key={i} className="border-border/50">
                  <TableCell className="py-2">
                    <span className="text-xs font-medium text-foreground 2xl:text-sm">
                      {/* {employeeMap.get(item.absence.employeeId)?.name || */}
                      {/* "Empleado"} */}
                    </span>
                  </TableCell>
                  <TableCell className="py-2">
                  ...
                  <TableCell className="py-2">
                    {item.replacements.length > 0 ? (
                      <span className="text-xs text-foreground 2xl:text-sm">
                        ...
                        {/*   .map( */}
                        {/*     (r) => */}
                        {/*       employeeMap.get(r.replacementId)?.name || */}
                        {/*       "Reemplazo", */}
                        {/*   ) */}
                        {/*   .join(", ")} */}
                      </span>
                  ...
                  <TableCell className="py-2">
                    {item.replacements.length > 0 ? (
                      <Badge
                        variant="outline"
                        className="text-[10px] py-0 text-primary border-primary/30 2xl:text-xs"
                      >
                      ...
                      <Badge
                        variant="outline"
                        className="text-[10px] py-0 text-destructive border-destructive/30 2xl:text-xs"
                      >
