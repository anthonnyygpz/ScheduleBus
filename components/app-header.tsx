...
import { CalendarClock, Users, LayoutDashboard, AlertTriangle } from "lucide-react"
    ...
    <header className="border-b border-border bg-card">
      <div className="flex items-center justify-between px-4 py-2 2xl:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold text-foreground leading-tight 2xl:text-base">ShiftFlow</h1>
            <p className="text-[10px] text-muted-foreground 2xl:text-xs">Gestion Inteligente de Horarios</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 rounded-md bg-secondary px-2 py-1">
          ...
          <span className="text-[10px] text-muted-foreground 2xl:text-xs">En vivo</span>
        </div>
      </div>
    </header>
  )
